...
<style type="text/css">
	...
	.title{
	font-size:20pt;padding:5px;text-align:center;width:80%; font-style: border;
	}
...
<body>
	<form action = "updateOk.jsp" method="post" onsubmit="return formCheck();">
		<table>
			<tr>
				<td colspan="4" class="title">방명록 수정하기</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3">
					<textarea name="content" id="content" cols="81" rows="10" required="required"><%=vo.getContent() %></textarea>
				</td>
			</tr>
			...
			<tr>
				<td colspan="4" align="right" style="padding-right:120px;">
					<input type="submit" value="저장하기" class="btn btn-outline-success btn-sm"/>    
				 	...
				 	<input type="button" value="취소" class="btn btn-outline-success btn-sm" 
