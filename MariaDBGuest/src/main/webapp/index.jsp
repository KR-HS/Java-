...
<%
	// 페이지 정보를 얻어온다.
	PagingVO<GuestbookVO> pv = GuestbookService.getInstance().selectList(currentPage,pageSize,blockSize);
...
<style type="text/css">
	...
	.title{
		width:100%; margin:auto; border:none; font-size: 18pt; text-align:center;
	}	

	.pageInfo{
		width:100%; margin:auto; border:none; font-size: 10pt; text-align:right;
	}
