...
public class Ex06 {
	...
	public static void main(String[] args) {
		...
		userid.sendKeys("jjc5989");
		WebElement password = driver.findElement(By.id("pw"));
		password.sendKeys("rlagustn2716!!");
		*/
		
		// 자바스크립트를 실행한다.
	      JavascriptExecutor js = (JavascriptExecutor) driver;  
	      js.executeScript("document.getElementById('id').value='jjc5989';");
	      js.executeScript("document.getElementById('pw').value='rlagustn2716!!';");
